...
class Welcome extends Component {
  ...
  render() {
    return (
      <View style={{ flex: 1, backgroundColor: colors.primaryBorder }}>
        ...
        <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ height: 150, width: 200, elevation: 15 }}>
            <Animatable.Image animation="fadeIn" duration={500} resizeMode="contain" source={require('../assets/new_logo-no-bg.png')} style={{ height: 150, width: 200 }} />
          </View>
        </View>
        <Loader />
      </View>
